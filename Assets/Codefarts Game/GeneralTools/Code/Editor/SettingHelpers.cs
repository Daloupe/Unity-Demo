...
namespace Codefarts.GeneralTools.Editor
{
    ...
    public static class SettingHelpers
    {
        ...
        /// </param>
        /// <param name="changed">A callback that will be invoked if the state of the control changes.</param>    
        public static void DrawSettingsTextBox(string key, string text, string defaultValue, Action changed)
        {
            var textValue = defaultValue;
            var settings = SettingsManager.Instance;
            ...
            var value = GUILayout.TextArea(textValue);
            if (value != textValue)
            {
                settings.SetValue(key, value);
                if (changed != null)             
        ...
        /// The default value for the setting.
        /// </param>
        public static void DrawSettingsTextBox(string key, string text, string defaultValue)
        {
            DrawSettingsTextBox(key, text, defaultValue, null);
        }
